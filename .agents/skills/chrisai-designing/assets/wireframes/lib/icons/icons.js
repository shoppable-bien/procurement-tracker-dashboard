(function () {
  ...
  function svg(name) {
    var path = paths[name];
    if (!path) {
      if (window.console && window.console.warn) window.console.warn('Unknown wireframe icon: ' + name);
      return '';
    }
    return '<span class="wf-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" focusable="false">' + path + '</svg></span>';
  }
